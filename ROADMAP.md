...
> 更新日期：2026-05-17
> 目前線上版本：**v3.14**（SEL 逆境特別篇 + 16 型結局動畫 + 猜朋友 MBTI 遊戲）
...
| 優先 | 項目 | 工時 | 為什麼這麼急 |
|---|---|---|---|
| 🥇 | **S1** 自我探索三部曲課程包 | 2 天 | 把所有零散內容串成完整課程，老師備課省力到爆 |
| 🥇 | **R1** Gemini for SEL — 情緒處方 | 1 天 | C1+N4 一句 prompt 就連起來 |
...
| 🥉 | **O4** 情緒急救卡 PDF | 0.5 天 | 學生帶在身上，老師會超感動 |
| 🥉 | **Q3** SEL 結果頁慶祝動畫 | 0.3 天 | 跟 MBTI 體驗對齊，幾乎沒成本 |
