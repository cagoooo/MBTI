...
> 更新日期：2026-05-17
> 目前線上版本：**v3.12**（RWD 全面優化 — 手機可讀性 + 注音模式佈局整治）
...
| 優先 | 項目 | 工時 | 為什麼這麼急 |
|---|---|---|---|
| 🥇 | **B1** 班級 MBTI 動態歷史 | 2 天 | Firebase RTDB 已建好，最低門檻最高效益 |
| 🥇 | **B2** 課前/課後自我評估對照 | 1 天 | 課程紀錄價值大、家長日有材料 |
| 🥇 | **E4** 完整無障礙稽核 | 1.5 天 | 學校採購硬需求、不做就是 risk |
| 🥈 | **G1** 一鍵 fork 模板 | 2 天 | 一個下午幫全國老師加值，影響力 ROI 爆表 |
| 🥈 | **C1** Gemini 個人化分析 | 1.5 天 | 用免費額度做出 wow 效果 |
| 🥉 | **A1+A2** 視覺插畫升級 | 5-7 天 | 美術升級，孩子的「捨不得關」關鍵 |
