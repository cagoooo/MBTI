 ...
 *   小傑 — 單親爸爸忙碌
 *   宇航 — 阿公會手語 (家有聽障家人)
 *   ─── v3.20 新增 4 角色 (補族群 / 信仰 / 藍領 / 身障) ───
 *   Akiya — 阿美族原住民,寒暑假回部落
 *   小恆  — 基督徒家庭,週日上主日學
 *   阿翔  — 爸爸修車師傅,從小幫忙遞工具
 *   詩晴  — 坐輪椅,輪椅舞蹈隊
 * 不刻意說教,只在第二/三輪台詞自然帶到。
 * 設計原則:「她是她」優先,「代表某個群體」次之。
 */
const STUDENTS: Student[] = [
  ...
  },
  {
    ...
    lines: [
      ...
      "週末媽媽們帶我去看其他朋友的家庭聚會 — 每個家都長得不一樣，超有趣。",
    ],
  },
  {
    ...
    lines: [
      ...
      "我吃花生會起疹子,所以便當絕對不能交換。同學都記得了,我超感動。",
    ],
  },
  {
    ...
    lines: [
      ...
      "媽媽在便當店做事,所以我傍晚 6 點才回家,要自己熱晚餐。",
    ],
  },
  // ─── v3.20 新增 4 個 NPC ───
  {
    name: "Akiya", emoji: "🌿", type: "INFP", badge: "bg-emerald-300",
    lines: [
      "Maoasu! (阿美族問候語) 我叫 Akiya, 來自花蓮。",
      "每個寒暑假我回部落幫阿嬤種小米,星空超美。",
      "我們族語有一個字「dafak」是「跟太陽一起醒來」,超詩意。",
    ],
  },
  {
    name: "小恆", emoji: "⛪", type: "ISTJ", badge: "bg-cyan-300",
    lines: [
      "我是小恆,我家全家都是基督徒。",
      "週日上午要上主日學,所以週六派對我都很早走,沒關係的。",
      "我超喜歡教會的詩歌團,我學鋼琴伴奏一年了。",
    ],
  },
  {
    name: "阿翔", emoji: "🔧", type: "ISTP", badge: "bg-slate-300",
    lines: [
      "我從小幫爸爸遞工具,現在會自己修腳踏車了。",
      "爸爸是修車師傅,他說『手藝是吃不完的本錢』。",
      "週末他教我換機油,我覺得超帥。長大想跟他一樣。",
    ],
  },
  {
    name: "詩晴", emoji: "💃", type: "ESFP", badge: "bg-fuchsia-300",
    lines: [
      "我叫詩晴,我坐輪椅。我喜歡跳舞 — 用手跳!",
      "我們學校的輪椅舞蹈隊上週剛拿了縣賽第二名 🏆",
      "校外教學要先問我能不能去,而不是直接覺得我不能 — 這超重要的!",
    ],
  },
];
  ...
  useEffect(() => {
    ...
    const interval = setInterval(() => {
      setActiveIdx((i) => {
        ...
        // 每輪走完所有角色才換到下一輪台詞 (3 輪: 興趣 / 家庭背景 / 文化或日常)
        if (next === 0) setLineIdx((li) => (li + 1) % 3);
        return next;
      });
    }, 3200);
