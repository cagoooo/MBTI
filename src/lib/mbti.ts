...
const MBTI_DATA: Record<MBTIType, MBTIInfo> = {
  INTJ: {
    ...
    futureJobs: ["科學家", "軟體工程師", "建築師", "外交官", "戰略顧問"],
  ...
  INTP: {
    ...
    futureJobs: ["研究員", "程式設計師", "發明家", "數學家", "考古學家"],
    famous: ["愛因斯坦", "達文西"],
  ...
  ENTP: {
    ...
    futureJobs: ["創業家", "編劇", "律師", "行銷專家", "脫口秀演員"],
    famous: ["馬克吐溫", "蘇格拉底"],
  ...
  INFJ: {
    ...
    futureJobs: ["心理諮商師", "作家", "輔導老師", "社工", "藝術家"],
    famous: ["馬丁路德金", "聖雄甘地"],
  ...
  ENFJ: {
    ...
    futureJobs: ["老師", "心理諮商師", "活動策劃", "外交官", "公益創辦人"],
    famous: ["歐普拉", "馬丁路德金"],
  ...
  ENFP: {
    ...
    futureJobs: ["記者", "演員", "創業家", "活動主持人", "兒童文學作家"],
    famous: ["華特迪士尼", "羅賓威廉斯"],
  ...
  ISFJ: {
    ...
    futureJobs: ["護理師", "老師", "圖書館員", "幼教老師", "獸醫"],
    famous: ["德蕾莎修女", "羅莎·帕克斯"],
  ...
  ESFJ: {
    ...
    futureJobs: ["護理師", "老師", "活動企劃", "餐廳老闆", "禮賓專員"],
  ...
  ISTP: {
    ...
    futureJobs: ["機械師", "飛行員", "外科醫師", "工程師", "運動員"],
    famous: ["邁可·喬丹", "貝爾·吉羅斯"],
  ...
  ISFP: {
    ...
    futureJobs: ["插畫家", "音樂家", "舞者", "服裝設計師", "攝影師"],
    famous: ["麥可·傑克森", "波·迪倫"],
    bestMatches: ["ESFJ", "ESTJ", "ENFJ"],
  ...
  ESTP: {
    ...
    futureJobs: ["運動員", "消防員", "創業家", "業務員", "急診醫師"],
  ...
  ESFP: {
    ...
    futureJobs: ["演員", "歌手", "活動主持", "幼教老師", "美食家"],
